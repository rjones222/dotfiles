...
alias igl-staging-rsync="cd ~/Sites/casesladder-repos/igl && rsync --recursive --links --checksum --progress --exclude-from=./.rsync-exclude --chmod=Dugo+rwX,u+rw,go+r ./. clsw:/opt/igl/ && cd -"
alias zf1-staging-rsync="cd ~/Sites/casesladder-repos/zf1 && rsync --recursive --links --checksum --progress --exclude-from=./.rsync-exclude --chmod=Dugo+rwX,u+rw,go+r ./. clsw:/opt/zf1/ && cd -"
alias myleague1-staging-rsync="cd ~/Sites/casesladder-repos/myleague && rsync --recursive --links --checksum --progress --exclude-from=./.rsync-exclude --chmod=Dugo+rwX,u+rw,go+r ./. clsw:/opt/myleague/ && cd -"
alias myleague2-staging-rsync="cd ~/Sites/casesladder-repos/myleague && rsync --recursive --links --checksum --progress --exclude-from=./.rsync-exclude --chmod=Dugo+rwX,u+rw,go+r ./. clscs:/opt/myleague/ && cd -"
